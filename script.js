...
const CATALOGO = {
  prePartita: [
    ...
    "Post sbronza: 2 dei giocatori titolari non si sono presentati alla rifinitura. Mettili in tribuna per tutta la partita.",
    "Nessun Imprevisto, ti è andata bene...",
    "Nessun Imprevisto, ti è andata bene...",
    "In difesa dei piu deboli !! Il nostro allenatore è molto magnanimo ed esige che ogni calciatore sia integrato nel gruppo. Schiera titolare per tutta la prossima partita il giocatore con peggior Overall in rosa.",
    ...
    "Ristorante di sushi non raccomandato: Alcuni calciatori provano un nuovo ristorante di sushi appena aperto, che purtroppo si rivela una cattiva idea. Dovrai tenere 3 dei tuoi calciatori titolari in tribuna causa forte dissenteria e cambiare modulo di gioco.",
    ...
    "Ma cosa ti viene in mente??: Estrai un modulo random e scambia di posizione per tutta la partita due giocatori scelti casualmente.",
    "Nessun Imprevisto, ti è andata bene...",
    "Nessun Imprevisto, ti è andata bene...",
    ...
    "Allenamento punitivo: Il Mister è furioso dell'atteggiamento dei suoi: tutti i giocatori con energia sotto l’80 partono titolari.",
    ...
    "Nessun Imprevisto, ti è andata bene...",
    "Nessun Imprevisto, ti è andata bene...",
    "Acchiappa la talpa: Una simpatica talpa si è divertita a distruggere il terreno di gioco la notte prima di una partita importante. La squadra che gioca in casa avrà l'errore tiri aumentato al massimo.",
    ...
    "Allenatore Visionario: E' arrivato il momento di far sbocciare il talento nascosto dei nostri ! Un difensore centrale a tua scelta deve giocare COC.",
    ...
    "Nazionalismo improvviso: Estrai una nazionalità random. Almeno 2 giocatori di quella nazione devono partire titolari. Se non ne hai abbastanza, pesca tra gli svincolati",
    "Confusione negli appunti: Il Mister ha portato a bordocampo un quaderno degli appunti ma pare che non sia il suo. Negli ultimi 30' di gara imposta un modulo con la difesa a 5 se stai vincendo oppure impostane uno con la difesa a 3.",
    "Esperimento statistico: La società prova a dispensare consigli alla squadra ma decide di affidarsi al caso. Lancia il dado, se pari → solo giovani unnder 21 titolari. Se dispari → solo over 28.",
    "Turnover forzato: Il preparatore dei portieri ha organizzato una serata cinema nella sua casa in campagna, i ragazzi si sono divertiti un sacco ma hanno fatto le ore piccole. Estrai 4 giocatori random con il dado, tutti devono partire titolari ed almeno 2 devono fare 90'.",
    "Nessun Imprevisto, ti è andata bene...",
    "Nessun Imprevisto, ti è andata bene...",
    ...
    "Influenza internazionale: Uno strano virus ha colpito un determinato numero di giocatori che erano in stanza insieme o comunque adiacenti. Estrai un calciatore tramite Lancio del Dado. Tutti i giocatori di quella nazione non possono essere convocati per la prossima partita.",
